...
Round 2 of the "7 Levels of Building Claude Code Websites" experiment (round 1: yellow iPhone, `~/experimental/design-yellow-iphone-web`, published at https://github.com/chizhangucb/claude-code-seven-levels-building-website). Same 7-level ladder, same Fable 5 vs Opus 4.8 A/B with identical prompts, new product: a **pink Cybertruck** selling site. Powers a 60-minute talk on leveling up website quality in Claude Code.
